...
import AdminRoomImageField from "@/features/rooms/components/admin/AdminRoomImageField";
import {
  createAdminRoom,
  updateAdminRoom,
} from "@/features/rooms/services/apiAdminRooms";
import {
  showErrorToast,
  showSuccessToast,
    ...
    <form onSubmit={handleSubmit(onSubmit, onInvalid)} className="space-y-8">
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-3">
          <div className="space-y-2">
            <label htmlFor="tables" className="text-sm font-medium text-slate-700">
              Tables
            </label>
            <Input
              id="tables"
