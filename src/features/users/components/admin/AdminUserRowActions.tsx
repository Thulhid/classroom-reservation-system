...
import { deleteAdminUser } from "@/features/users/services/apiAdminUsers";
import {
  showErrorToast,
  showSuccessToast,
  ...
  return (
    <>
      <DropdownMenu open={isMenuOpen} onOpenChange={setIsMenuOpen}>
        ...
        <DropdownMenuContent align="end" className="w-48">
          ...
          <DropdownMenuItem
            onSelect={() => {
              setIsMenuOpen(false);
              router.push(`${getManagedUsersRoute(user.role)}/${user.id}/edit`);
            }}
          >
      ...
      <AlertDialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete this {roleLabel.toLowerCase()}?</AlertDialogTitle>
            <AlertDialogDescription>
